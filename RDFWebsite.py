        ...
        html.Div(className = 'row', style = {'backgroundColor' : '#c1c1c1', 'width' : '25%', 'borderStyle' : 'solid', 'borderWidth' : '0px','textAlign' : 'center'}, children=[
            html.Div(children = [
                ...
                dcc.Checklist(id = 'xgridcheck',
                    options=[
                        {'label': 'x gridlines', 'value': 'xgridval'}
                    ],
                    values=[],
                    ),
                ...
                dcc.Checklist(id = 'ygridcheck',
                    options=[
                        {'label': 'y gridlines', 'value': 'ygridval'}
                    ],
                    values=[],
                    ),
...
@app.callback(ddep.Output('RDF_Graph', 'figure'),[ddep.Input('sOrbCheck', 'values'),ddep.Input('pOrbCheck', 'values'),ddep.Input('dOrbCheck', 'values'),ddep.Input('fOrbCheck', 'values'),ddep.Input('WFType', 'value'), ddep.Input('LineWidthSlider','value'), ddep.Input('TextSizeSlider','value'), ddep.Input('xgridcheck','values'), ddep.Input('ygridcheck','values'), ddep.Input('ZeffSlider','value'),ddep.Input('UpperxInput', 'value'),ddep.Input('LowerxInput', 'value')])

#Function which is called after the element is pressed
def UpdatePlot(svals, pvals, dvals, fvals, WFType, Thickness, TextSize, xgridinput, ygridinput, zeff, upperxlim, lowerxlim):
